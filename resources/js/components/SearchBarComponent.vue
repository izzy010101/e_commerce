<template>
    <div>
        <form @submit.prevent="search">
            ...
            <ul v-if="limitedResults.length" class="absolute bg-white border border-gray-300 rounded-lg mt-2 w-full max-h-60 overflow-y-auto z-10">
                <li
                ...
                <div v-if="noResults" class="absolute mt-2 w-full bg-white border border-gray-300 rounded-lg">
                    <p class="px-4 py-2 text-gray-500">No products found</p>
                </div>
            </ul>
        </form>
    </div>
