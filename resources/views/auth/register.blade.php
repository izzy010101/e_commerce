...
<x-guest-layout>
    ...
    <div class="flex flex-col lg:flex-row gap-4 p-6">
        <form method="POST" action="{{ route('register') }}" class="w-full lg:w-1/2 h-auto lg:h-[500px]">
            @csrf
        ...
        <div class="card w-full lg:w-1/2 h-auto lg:h-[500px] flex content-center justify-center mt-8 lg:mt-0">
            <div class="w-full lg:w-1/2 rounded bg-[#e0e2e6] h-auto lg:h-[360px] p-4 lg:p-6">
