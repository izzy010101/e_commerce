        ...
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <span class="me-3 [&>svg]:h-4 [&>svg]:w-4">
                ...
                <p>
                    At Ziara Clothing, we are dedicated to offering the latest trends and timeless pieces that suit every style. Our commitment to quality and innovation ensures that you look and feel your best.
                </p>
            </div>
            <!-- Products section -->
            <div>
